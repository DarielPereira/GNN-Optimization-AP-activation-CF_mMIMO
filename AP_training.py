...
try:
    dataset.load(f'./AP_TrainingData/Dataset_'+dataConfiguration+'.pt')
except:
...
model.save_model(f'./AP_TrainingData/Model_'+dataConfiguration+f'_Epochs_{num_epochs}_SAGEConv_sum.pt')
